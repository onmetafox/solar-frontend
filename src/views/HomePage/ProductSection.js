    ...
    return <Box className = "product-section p-tb-80">
        <Container maxWidth="xl">
            <Grid container textAlign="center" direction="column" alignItems="center" justifyContent="center" spacing={5}>
                ...
                <Grid item xs={6} >
                    <Box className="fs-2 t-p" maxWidth={640}>Solar is a decentralised blockchain using a Delegated Proof of Stake consensus model which is secured by 53 elected block producers that produce blocks and validate transactions.</Box>
                </Grid>
                <Grid item xs = {12}>

                    ...
                    <Grid item xs= {12} >
                        <Grid container spacing={5} sx={{ flexGrow: 1 }} direction="row" justifyContent="center" alignItems="center">
                            <Grid item lg={6} md = {6} sm = {6} sx={{ flex: 1 }}>
                                <Box className="h0 t-p mt-40">Solar Enterprises</Box>
                                ...
                                {/* <Box className="fs-s2 t-p mt-20">Solar Enterprises is a business dedicated to enhancing the Solar Network ecosystem.</Box> */}
                                <Stack direction="row" className="mt-20" sx={{textAlign:'center'}} spacing={2}>
                                    <Link href="https://t.me/solarenterprises" icon={false} className="btn-lg bg-gp p-lr-20 no-line non-hover" title="Join community" />
                                </Stack>
                            </Grid>
